...
```bash
# Clone
git clone https://www.github.com/meorphis-test/test-repo-12
cd test-repo-12
...
You can release to package managers by using [the `Publish NPM` GitHub action](https://www.github.com/meorphis-test/test-repo-12/actions/workflows/publish-npm.yml). This will require a setup organization or repository secret to be set up.
