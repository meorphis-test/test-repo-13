...
import * as FinancialTransactionsAPI from 'meorphis-test-25/resources/cards/financial-transactions';
...
export namespace Cards {
  ...
  export import FinancialTransaction = CardsAPI.FinancialTransaction;
